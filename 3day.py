...
def find_generic_item(compartment_a, compartment_b):
    intersection = set(compartment_a).intersection(set(compartment_b))
...
def calculate_sum_of_priorities():
    total = 0
    file = open("test-input-3day.txt", mode="r")
    ...
    while line:
        ...
        generic = find_generic_item(compartment_a, compartment_b)
        print(generic)
        line = file.readline()
...
if __name__ == "__main__":
    result = calculate_sum_of_priorities()
    print(result)
